...
$('.navig').click(function() {
  ...
  window.location.assign("http://luffy.ee.ncku.edu.tw:2123/index.html?"+redir_url+"&navig="+dog_page_route);
});

$('.XXicon').click(function() {
  window.location.assign("http://luffy.ee.ncku.edu.tw:2123/index.html?"+redir_url+"&");
});
